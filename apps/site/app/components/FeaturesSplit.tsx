  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20 flex flex-col lg:flex-row items-center gap-16" id="solutions">
      <div className="flex-1">
        ...
        <a href="https://app.danesproperties.com/register" className="inline-flex items-center gap-2 bg-white text-dark-900 px-6 py-2.5 rounded-full text-sm font-semibold mt-8 hover:bg-paper-100 transition-all hover:scale-105">
